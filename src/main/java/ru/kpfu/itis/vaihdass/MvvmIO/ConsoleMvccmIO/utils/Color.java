package ru.kpfu.itis.vaihdass.MvvmIO.ConsoleMvccmIO.utils;
...
public abstract class Color {
    ...
    public static String black(String text) {
        return AnsiColors.reset() + AnsiColors.ANSI_BLACK.text() + text + AnsiColors.reset();
    }
    public static String red(String text) {
        return AnsiColors.reset() + AnsiColors.ANSI_RED.text() + text + AnsiColors.reset();
    }
    public static String green(String text) {
        return AnsiColors.reset() + AnsiColors.ANSI_GREEN.text() + text + AnsiColors.reset();
    }
    public static String yellow(String text) {
        return AnsiColors.reset() + AnsiColors.ANSI_YELLOW.text() + text + AnsiColors.reset();
    }
    public static String blue(String text) {
        return AnsiColors.reset() + AnsiColors.ANSI_BLUE.text() + text + AnsiColors.reset();
    }
    public static String purple(String text) {
        return AnsiColors.reset() + AnsiColors.ANSI_PURPLE.text() + text + AnsiColors.reset();
    }
    public static String cyan(String text) {
        return AnsiColors.reset() + AnsiColors.ANSI_CYAN.text() + text + AnsiColors.reset();
    }
    public static String white(String text) {
        return AnsiColors.reset() + AnsiColors.ANSI_WHITE.text() + text + AnsiColors.reset();
    }
